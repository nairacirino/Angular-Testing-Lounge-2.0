...
@Component({
  selector: 'app-input-binding-fun',
  templateUrl: './input-binding-fun.component.html',
  styleUrls: ['./input-binding-fun.component.scss']
})
export class InputBindingFunComponent implements OnInit {
