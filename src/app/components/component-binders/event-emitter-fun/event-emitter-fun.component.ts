...
@Component({
  selector: 'app-event-emitter-fun',
  templateUrl: './event-emitter-fun.component.html',
  styleUrls: ['./event-emitter-fun.component.scss']
})
export class EventEmitterFunComponent implements OnInit {
