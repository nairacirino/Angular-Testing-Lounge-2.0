...
@Component({
  selector: 'app-ngswitch-fun',
  templateUrl: './ngswitch-fun.component.html',
  styleUrls: ['./ngswitch-fun.component.scss']
})
export class NgswitchFunComponent implements OnInit {
