...
@Component({
  selector: 'app-ngcontainer-fun',
  templateUrl: './ngcontainer-fun.component.html',
  styleUrls: ['./ngcontainer-fun.component.scss']
})
export class NgcontainerFunComponent implements OnInit {
